...
#Publish-Project -ProjectName "RTLSDR.Common" -PackageVersion "1.0.9" -PSScriptRoot $PSScriptRoot -Token $token
...
Publish-Project -ProjectName "RTLSDR.DAB" -PackageVersion "1.0.12" -PSScriptRoot $PSScriptRoot -Token $token
